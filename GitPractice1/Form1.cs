namespace GitPractice1
{
    public partial class Form1 : Form
    {
        ...
        /* 1. –азобратьс€ как работают конвертеры. -d.
         * 2. —делать конвертер. -d.
         * 3. —делать соотношение валют, хранение значени€ одного к другому и т.д. т.п. -d.
         * 4.  омитить этапы разработки.
         */
